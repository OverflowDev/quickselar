    ...
    <div className="bg-blue-50 py-16">
      ...
      <div className=" md:max-w-screen-xl px-4 mt-3 mx-auto sm:px-6 lg:px-8">
        <div className="flex flex-row gap-8">
          ...
          <div className="flex-col md:w-1/3 h-48 bg-white hover:bg-blue-600 rounded-lg animate-fadeInUp delay-100 duration-100 px-6 py-2">
            <div className="flex items-center justify-center space-x-4 text-2xl text-blue-800 font-semibold">
