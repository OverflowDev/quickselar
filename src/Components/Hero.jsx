...
function Hero() {
  return (
    <section className="bg-center bg-cover bg-no-repeat bg-gray-700 bg-blend-multiply" style={{ backgroundImage: `url(${HeroBackground})` }}>
        <div className="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
            ...
            <p className="mb-8 text-lg font-normal text-gray-300 lg:text-xl sm:px-16 lg:px-48">Here at QuickSelar we focus on markets where technology, innovation, and capital can unlock long-term value and drive economic growth.</p>
